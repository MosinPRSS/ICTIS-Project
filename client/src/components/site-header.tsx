...
export function SiteHeader() {
  ...
  function getIcon(themeName: string): React.RefAttributes<SVGSVGElement> | undefined {
      ...
      <div className="flex w-full items-center gap-1 px-4 lg:gap-2 lg:px-6">
        ...
        {isPalette ? 
          ...
          >
            {Theme.map((e) => (
              <Button 
                className={`cursor-pointer border ${theme.options.hoverBgColor2} ${theme.options.hoverTextColor2}`}
