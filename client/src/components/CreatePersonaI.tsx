...
export function CreatePersonaI(){
  ...
  return (
      ...
      >
        <div className="space-y-1">
          <p className={`text-4xl font-bold ${theme.options.textColor}`}>Создать персону</p>
          <p className={`text-l ml-1 font-bold ${theme.options.textColor}`}>Как к вам будут обращаться ваши собеседники?</p>
                    ...
                    <div className={`${theme.options.bgColor} outline rounded-2xl p-6 m-10 relative`}>
                      <div className="flex flex-row justify-start gap-6 bg-muted p-3 md:p-10">
                        <div className="flex flex-col space-y-4">
                          <p className={`${theme.options.textColor} text-2xl mb-5`}>Персона успешно создана!</p>
                          <div className={`flex flex-row ${theme.options.textColor} items-center space-x-5`}>
                            ...
                            <Button
                              ...
                              onClick={() => {pageFunc('/userpersonas'); navigate('/userpersonas')}}
                              variant='outline'
                            >
