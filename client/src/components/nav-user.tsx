        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <div className="flex flex-row p-1 space-x-2 items-center">
              ...
              <Button onClick = {() => regFunc(false)} className="w-[10px] hover:bg-white hover:text-black outline rounded-sm cursor-pointer group-data-[collapsible=icon]:hidden origin-left">
