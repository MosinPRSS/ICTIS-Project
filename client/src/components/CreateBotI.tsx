  ...
  return (
      ...
      >
        <div className="space-y-1">
          ...
          <div className="ml-15 group relative mt-15 w-70 h-70 rounded-full bg-gradient-to-r from-[#c2a4f5] to-[#8c38c8] border-2 border-[#594db2] shadow-lg mx-auto mb-8 flex items-center justify-center transform transition-all hover:-translate-y-1 hover:rotate-x-6 hover:shadow-xl">
        ...
        <div className={`relative h-screen p-5 w-[60%]`}>
